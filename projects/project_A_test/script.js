...
window.addEventListener('scroll', function(){ // on page scroll
  ...
  let pageHeight=7*windowHeight-windowHeight;
  let percent=scrolltop/pageHeight;
  ...
  //   let imgStage1=planning[i].imgStage1;
  //   let imgStage2=planning[i].imgStage2;
  //   // console.log(planning[i].stage1);
  //   console.log(cursorStage1, cursorStage2);
  //   if (percent>=0&&percent<cursorStage1){
  //     imgs[i].style.top = map(percent,0,cursorStage1,0,imgStage1)+"px";
  //   }else if (percent>=cursorStage1 && percent<cursorStage2){
  //     imgs[i].style.top = map(percent,cursorStage1,cursorStage2,imgStage1,0)+"px";
  //   }else if(percent>=cursorStage2 && percent<cursorStage3){
  //     imgs[i].style.top = map(percent,cursorStage2,cursorStage3,0,imgStage2)+"px";
  //   }
    // else{
